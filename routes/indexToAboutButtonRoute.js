...
const indexToAboutButtonRoute = (req, res, sessions) => {
  ...
  // Generate a signed URL for aboutUs.html with session ID
  const signedUrl = generateSignedUrl('../views/aboutUs.html', sessionId);
